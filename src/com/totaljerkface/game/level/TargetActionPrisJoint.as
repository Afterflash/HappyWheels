package com.totaljerkface.game.level
{
    ...
    public class TargetActionPrisJoint extends LevelItem
    {
        protected var _refSprite:RefSprite;
        
        protected var _joint:b2PrismaticJoint;
        ...
        public function TargetActionPrisJoint(param1:RefSprite, param2:b2PrismaticJoint, param3:String, param4:Array)
        {
            super();
            ...
            switch(this._action)
            {
                ...
                case "change limits":
                    if(this._joint)
                    {
                        ...
                        _loc1_ = this._properties[0] / m_physScale;
                        _loc2_ = this._properties[1] / m_physScale;
        ...
        public function set joint(param1:b2PrismaticJoint) : void
        {
            this._joint = param1;
        }
