package com.totaljerkface.game.level.userspecials
{
    ...
    import com.totaljerkface.game.editor.specials.Building1Ref;
    import com.totaljerkface.game.editor.specials.Special;
    import com.totaljerkface.game.level.LevelItem;
    import flash.display.Sprite;
    import flash.geom.Matrix;
    
    public class Building1 extends LevelItem
    {
        private var sprite:Sprite;
        
        public function Building1(param1:Special)
        {
            ...
            this.sprite.graphics.beginBitmapFill(_loc9_.getTexture(Building1Ref.B1_ROOF),_loc10_,true,false);
            this.sprite.graphics.drawRect(_loc6_,_loc7_,_loc4_,100);
            this.sprite.graphics.endFill();
            _loc7_ += 100;
            _loc10_ = new Matrix(1,0,0,1,_loc6_,_loc7_);
            this.sprite.graphics.beginBitmapFill(_loc9_.getTexture(Building1Ref.B1_FLOOR),_loc10_,true,false);
            this.sprite.graphics.drawRect(_loc6_,_loc7_,_loc4_,165 * _loc2_.numFloors);
            this.sprite.graphics.endFill();
