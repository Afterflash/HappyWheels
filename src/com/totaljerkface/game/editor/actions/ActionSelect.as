package com.totaljerkface.game.editor.actions
{
    ...
    public class ActionSelect extends Action
    {
        ...
        public function ActionSelect(param1:RefSprite, param2:Array, param3:int, param4:ArrowTool)
        {
            super(param1,false);
        ...
        {
            trace("SELECT UNDO " + refSprite.name);
        ...
        {
            trace("SELECT REDO " + refSprite.name);
