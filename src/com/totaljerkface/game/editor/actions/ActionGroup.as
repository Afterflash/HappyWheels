package com.totaljerkface.game.editor.actions
{
    ...
    public class ActionGroup extends Action
    {
        ...
        public function ActionGroup(param1:RefSprite, param2:RefGroup, param3:RefGroup, param4:DisplayObjectContainer, param5:int)
        {
            super(param1);
        ...
        {
            trace("GROUP UNDO " + refSprite.name);
        ...
        {
            trace("GROUP REDO " + refSprite.name);
