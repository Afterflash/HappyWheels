package com.totaljerkface.game.editor.actions
{
    ...
    public class ActionRemoveKeyedIndex extends Action
    {
        ...
        public function ActionRemoveKeyedIndex(param1:RefSprite, param2:String, param3:Object, param4:int, param5:Object)
        {
            super(param1);
        ...
        override public function undo() : void
        {
            ...
            trace("REMOVE KEYED INDEX UNDO " + this._property + " " + this._key + " " + refSprite.name);
            ...
            var _loc3_:int = 0;
            while(_loc3_ < refSprite.triggerActionList.length)
            {
                _loc4_ = refSprite.triggerActionListProperties[_loc3_];
                if(_loc4_)
                {
                    _loc5_ = 0;
                    while(_loc5_ < _loc4_.length)
                    {
                        ...
                        _loc7_ = refSprite.keyedPropertyObject[_loc6_];
                        if(_loc7_)
                        {
                            _loc8_ = _loc7_[this._key];
                            if(_loc8_)
                            {
                                _loc8_.splice(this._index,0,this._tempObject[_loc6_]);
                            }
                        }
                        _loc5_++;
                    }
        ...
        override public function redo() : void
        {
            ...
            trace("REMOVE KEYED INDEX REDO " + this._property + " " + this._key + " " + refSprite.name);
            var _loc1_:Dictionary = refSprite.keyedPropertyObject[this._property];
            var _loc2_:Array = _loc1_[this._key];
